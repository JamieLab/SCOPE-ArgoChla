...
from oc_cci_kringing import oc_cci_fill, output_single_chla,output_final_files
...
version = 'v1-0'
out_loc = 'E:/SCOPE/Argo/'+version
argo_file = 'F:/Data/ARGO/argo_bio-profile_index_15032026.txt' #File containing all the current bio-argo profiles (this needs to be downloaded periodically)
...
argo_average(res,start_yr,end_yr,['F:/Data/_DataSets/chla/insitudb_chla_V3'],skiprows=28,sep='\t',dateti = True,datecol = 'Date/Time',dateformat='%Y-%m-%dT%H:%M',
...
#
# output_single_chla(occci_file,outloc ='F:/OceanCarbon4Climate/GCB2026/inputs/chla')
