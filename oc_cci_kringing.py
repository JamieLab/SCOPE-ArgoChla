...
def oc_cci_fill(file, bathy_file,daystep,res,reset = False,ice_name = 'OSISAF_sea_ice_fraction',plot=False,ref_step = 30.5,out_loc = False,single_out_loc = False,ice = True):
    ...
    c.variables['chl_flag'].flags = '1 = Land; 2 = OC-CCI observations; 3 = Cloud Kriging; 4 = Under sea ice; 5 = Southern Hemisphere backwards Argo relationship; 6 = Southern Hemisphere forwards Argo relationship; 7 = Northern Hemisphere backwards Argo relationship; 8 = Northern Hemisphere forwards Argo relationship; 9 = Final kriging (moderate sea ice zones)'
    ...
    c.supporting_manuscript = 'Daniel J. Ford, Gemma Kulk, Shubha Sathyendranath, Jamie D. Shutler, Decadal global and polar wintertime chlorophyll-a data record from satellite and Argo observations (in prep)'
